...
@Component({
	...
	selector: 'app-voice-schedule',
	templateUrl: './voice-schedule.component.html',
	styleUrls: ['./voice-schedule.component.scss']
})
export class VoiceScheduleComponent implements OnInit {
  ...
  disconnectFun(action){
    ...
    this.appComponent.disConnectSchedule(this.user_id,this.consultant_id,this.appointment_id,this.amount,this.count,data.user_disconnect,data.consult_disconnect,action,this.max_call_duration);
